			...
			<div class="content">
				...
				<fieldset>
					...
					<select name="unidade" id="unidade">
						<option value="Un" <?php if($unidade == "Un") echo 'selected="selected"'; ?>>Un</option>
						<option value="Gr" <?php if($unidade == "Gr") echo 'selected="selected"'; ?>>Gr</option>
						<option value="Kg" <?php if($unidade == "Kg") echo 'selected="selected"'; ?>>Kg</option>
					</select>
